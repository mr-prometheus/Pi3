#!/bin/bash
#SBATCH -J pi3_pose_vancouver
#SBATCH --mem=40GB
#SBATCH --gres=gpu:1 -C gmem32
#SBATCH --output=runs/pose_extract_vancouver_%j.out
...
VIDEO_PATH="videos/vancouver/vancouver_stanley_v5.mp4"
OUTPUT_DIR="output_videos/Vancouver"
